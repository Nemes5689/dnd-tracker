    ...
    <div>
      ...
      {character && (
        <div className="mt-6">
          ...
          {!character.weapons?.length && !character.notes && (
            <div className="text-[12px] text-text-tertiary italic">
              No detailed capabilities defined for this character. Add weapons
              and features in the Characters page.
            </div>
          )}
        </div>
      )}
  ...
  return (
    <div className="mb-5">
      ...
      <div className="text-[12px] leading-7 text-text-secondary">
        {/* Speed */}
        {Object.keys(monster.speed).length > 0 && (
          <div>
...
function formatSpeedFull(speed: Record<string, number>): string {
  const parts: string[] = [];
